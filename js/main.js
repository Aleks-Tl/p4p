...
// Transformation btns of admins ========================================================================================================================================================

if (document.querySelectorAll('.header').length > 0) {
  const admin = document.querySelector('.header__admin');
  const headerWrap = document.querySelector('.header__wrap');
  const navList = document.querySelector('.nav__list');
  function transformAdminPanel() {
    if (window.innerWidth <= 992) {
      navList.append(admin);
    } else {
      headerWrap.append(admin);
    }
  }
...
if (document.querySelectorAll(".header .nav ul a").length > 0) {
  const menuContainer = document.querySelectorAll(".header .nav ul a");
...
// Slider for section our-brands ========================================================================================================================================================

if (document.querySelectorAll('.our-brands__slider').length > 0) {
  const sliderOurBrands = document.querySelector('.our-brands__slider');
  const swiper = new swiper__WEBPACK_IMPORTED_MODULE_2__["default"](sliderOurBrands, {
...
new (wow_js__WEBPACK_IMPORTED_MODULE_4___default())().init();
...
if (laptopScreen.matches) {
  ...
  tl.fromTo('.commission__list li', {
    opacity: 0
  }, {
    opacity: 1,
    stagger: 0.2
  });
  tl.fromTo('.brands-single__link', {
    opacity: 0
  }, {
    opacity: 1
  }, '-=1.5');
  tl.fromTo('.brands-plurare__link', {
    opacity: 0
  }, {
    duration: 0.5,
    opacity: 1,
...
if (document.querySelectorAll('.tags').length > 0) {
  document.querySelectorAll('.tags__block ul li').forEach(elem => {
    elem.onmouseleave = e => {
      const tolerance = 10;
      const left = 0;
...
if (document.querySelectorAll('.section-faq').length > 0) {
...
// Show SEO block in blog page ========================================================================================================================================================

/* if (document.querySelectorAll('.blog').length > 0) {
  const btnShowMore = document.querySelector('.blog .blog__btn');
  const blockSubtitleBlog = document.querySelector('.blog .subtitle');

  btnShowMore.addEventListener('click', () => {
    blockSubtitleBlog.classList.toggle('show');
  })
} */
})();
